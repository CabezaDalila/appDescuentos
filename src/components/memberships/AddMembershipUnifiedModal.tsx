...
interface AddMembershipUnifiedModalProps {
  isOpen: boolean;
  onClose: () => void;
  onCreate?: (
...
const AddMembershipUnifiedModal: React.FC<AddMembershipUnifiedModalProps> = ({
  isOpen,
  onClose,
  onCreate,
}) => {
  ...
  // Estado para tarjetas (solo para bancos)
  ...
  const handleCreate = async () => {
    ...
    if (selectedCategory === "banco" && cards.length === 0) {
      toast.error("Los bancos deben tener al menos una tarjeta asociada");
      return;
    }
      ...
      <DialogContent className="max-w-md membership-modal">
        ...
        <div className="space-y-4">
          {step === "category" ? (
            ...
            // Paso 3: Agregar tarjeta (solo para bancos)
            <div className="space-y-4">
              {/* Información del banco */}
              <div className="p-3 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-700">
                  <strong>Banco:</strong> {customName}
                </p>
                <p className="text-xs text-blue-600 mt-1">
                  Agrega una tarjeta para crear el banco
                </p>
              </div>
              ...
              <div className="flex gap-2">
                ...
                >
                  {isCreating ? "Creando..." : "Crear Banco"}
                </Button>
              </div>
            </div>
          )}
...
export default AddMembershipUnifiedModal;
