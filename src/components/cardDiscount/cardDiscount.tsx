  ...
  return (
    <div className="flex justify-start flex-col bg-white rounded-lg p-2 gap-3">
        <div className="flex items-center justify-center h-70 w-full relative">
            ...
            <Image src={image} alt="Card Discount" width={100} height={100} className="object-cover w-full h-full" />
        </div>
     ...
     <div className="flex items-center justify-start gap-4">
        ...
        <span className="text-xs text-gray-500 flex items-center gap-1">
            <Image src="/expiration.png" alt="Expiration" width={10} height={10} />
            {expiration}
        </span>
     </div>
     ...
     <div className="flex flex-col gap-3">
        ...
        <div className="flex  flex-wrap gap-2">
            {applyWith.map((item: string) => (
                <Badge key={item} variant="outline" className="text-gray-500 gap-2">{item}</Badge>
            ))}
        </div>
     </div>
